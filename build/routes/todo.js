...
router.post("/", (0, validate_request_1.validateRequest)(todo_2.createTodoSchema), (0, asyncHandler_1.asyncHandler)(todo_1.default.createTodo));
router.delete("/:id", (0, asyncHandler_1.asyncHandler)(todo_1.default.deleteTodo));
router.put("/:id", (0, validate_request_1.validateRequest)(todo_2.updateTodoSchema), (0, asyncHandler_1.asyncHandler)(todo_1.default.updateTodo));
